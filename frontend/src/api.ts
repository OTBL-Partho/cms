...
export const getCMOs = (params?: { page?: number; limit?: number; status?: string; search?: string; sortBy?: string; sortOrder?: string; nocs?: string; dateFrom?: string; dateTo?: string; isMDMEntry?: string; cpcCpr?: string; noContact?: string }) => {
...
export const getCMOExportData = (params?: { search?: string; isApproved?: string; nocs?: string; dateFrom?: string; dateTo?: string; isMDMEntry?: string; cpcCpr?: string; noContact?: string }) => {
